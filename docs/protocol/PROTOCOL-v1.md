...
Транспорт — внутри процесса, а не именованный канал: ADR 0002 требует, чтобы протокол от транспорта не зависел, и conformance обязан это доказывать, а не предполагать. Настоящая оболочка появится в `4.0-F02`, и набор натравливают на неё, не переписывая требований.

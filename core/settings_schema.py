...
CONSTRAINTS: dict[str, Constraint] = {
    ...
    # Акцент вернулся: `4.0-R08` заменил пять палитр двумя отделками, но
    # акцент — не палитра, а один цвет с двумя обязанностями, и каждый его
    # вариант проверен на контраст. Набор перечисляет оболочка: варианты
    # зависят от отделки, а отделка — её дело.
    "accent": Constraint(),
